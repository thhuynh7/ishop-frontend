...
// this is a child component of Product page
  ...
  return (
    <>
      <div className="col-md-7">
        ...
        <Tabs type="card">
          ...
          <TabPane tab="More" key="2">
            Please visit manufacturer's official website to learn more about this product.
          </TabPane>
        </Tabs>
      </div>
      ...
      <div className="col-md-5">
        ...
        <h1 style={{ backgroundColor: "#ffc266" }} className="container p-3">{title}</h1>
