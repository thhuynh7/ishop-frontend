...
const ProductListItems = ({ product }) => {
  const { price, category, subs, bestseller, color, brand, quantity, sold } = product
  ...
  return (
    <ul className="list-group">
      ...
      <li className="list-group-item">
        Bestseller <span className="label label-default label-pill pull-xs-right">{bestseller}</span>
      </li>
