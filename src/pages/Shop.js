...
const Shop = () => {
  ...
  // 9. show products based on bestseller yes/no
  const showBestseller = () => (
    <>
      <Checkbox className="pb-2 pl-4 pr-4" onChange={handleBestsellerchange} value="Yes" checked={bestseller === "Yes"}>
        Yes
      </Checkbox>

      <Checkbox className="pb-2 pl-4 pr-4" onChange={handleBestsellerchange} value="No" checked={bestseller === "No"}>
        No
      </Checkbox>
    </>
  )
  ...
  const handleBestsellerchange = e => {
    ...
    fetchProducts({ bestseller: e.target.value })
  }
